  ...
  actions: {
    ...
    hasErrorForm() {
      ...
      if (this.data.person.type_person_id === '') {
        errorMessages.push({
          message: 'Informe o Tipo de person, Jurídica ou Física',
        })
      }
      ...
      if (this.data.person.type_person_id === 'F') {
        ...
        if (this.data.person.document_number === '') {
          errorMessages.push({
            message: 'Faltou informar o CPF',
          })
        }
        if (this.data.person.name === '') {
          errorMessages.push({
            message: 'Faltou informar o Nome',
          })
        }
      } else {
        if (this.data.person.document_number === '') {
          errorMessages.push({
            message: 'Faltou informar o CNPJ',
          })
        }
        if (this.data.person.name === '') {
          errorMessages.push({
            message: 'Faltou informar a Razão Social',
          })
        }
        if (this.data.person.short_name === '') {
          errorMessages.push({
            message: 'Faltou informar o nome de Fantasia',
          })
        }
      }
      ...
      if (this.data.person.street === '') {
        errorMessages.push({
          message: 'Faltou informar o logradouro',
        })
      }

      if (this.data.person.street_number === '') {
        errorMessages.push({
          message: 'Faltou informar o número do logradouro',
        })
      }

      if (this.data.person.district === '') {
        errorMessages.push({
          message: 'Faltou informar o bairro ou localidade',
        })
      }

      if (this.data.person.zip_code === '') {
        errorMessages.push({
          message: 'Faltou informar o CEP',
        })
      }

      if (this.data.person.city_id === '') {
        errorMessages.push({
          message: 'Faltou informar o Município',
        })
      }

      if (this.data.person.email === '') {
        errorMessages.value.push({
          message: 'Informe o email de contato',
        })
      }
